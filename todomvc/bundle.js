...
$jscomp.Map.getId_ = function (a) {
  ...
  $jscomp.Map.key_ in a ||
    (a instanceof Object &&
      Object.isExtensible &&
      Object.isExtensible(a) &&
      $jscomp.Map.defineProperty_(a, $jscomp.Map.key_, ++$jscomp.Map.index_));
...
$jscomp.Map.prototype.set = function (a, b) {
  ...
  c
    ...
    : ((c = {
      ...
      e.push(c),
      (this.head_.previous.next = c),
      (this.head_.previous = c),
      this.size++);
  return this;
};
  ...
  if (c)
    for (var d = 0; d < c.length; d++) {
      ...
      if ((a !== a && e.key !== e.key) || a === e.key)
        return { id: b, list: c, index: d, entry: e };
    }
...
$jscomp.Map.prototype.forEach = function (a, b) {
  for (
    var c = $jscomp.makeIterator(this.entries()), d = c.next();
    !d.done;
    d = c.next()
  )
...
$jscomp.Map.index_ = 0;
$jscomp.Map.defineProperty_ = Object.defineProperty
  ? function (a, b, c) {
...
$jscomp.Map$install = function () {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  !$jscomp.Map.ASSUME_NO_NATIVE && $jscomp.Map.checkBrowserConformance_()
...
$jscomp.math.imul = function (a, b) {
  ...
  return (
    (c * d +
      (((((a >>> 16) & 65535) * d + c * ((b >>> 16) & 65535)) << 16) >>> 0)) |
    0
  );
};
...
$jscomp.math.hypot = function (a, b, c) {
  ...
  b = Number(b);
  for (
    var f = Math.max(Math.abs(a), Math.abs(b)),
      g = $jscomp.makeIterator(d),
      e = g.next();
    !e.done;
    e = g.next()
  )
    f = Math.max(f, Math.abs(e.value));
  if (1e100 < f || 1e-100 > f) {
    a /= f;
    b /= f;
    g = a * a + b * b;
    ...
    for (e = d.next(); !e.done; e = d.next())
      (e = e.value), (e = Number(e) / f), (g += e * e);
    return Math.sqrt(g) * f;
  }
  f = a * a + b * b;
  d = $jscomp.makeIterator(d);
  for (e = d.next(); !e.done; e = d.next())
    (e = e.value), (e = Number(e)), (f += e * e);
  return Math.sqrt(f);
};
...
$jscomp.number.isSafeInteger = function (a) {
  return (
    $jscomp.number.isInteger(a) &&
    Math.abs(a) <= $jscomp.number.MAX_SAFE_INTEGER
  );
};
...
$jscomp.Set$install = function () {
  !$jscomp.Set.ASSUME_NO_NATIVE && $jscomp.Set.checkBrowserConformance_()
...
$jscomp.string.fromCodePoint = function (a) {
  for (var b = [], c = 0; c < arguments.length; ++c) b[c - 0] = arguments[c];
  for (
    var c = '', b = $jscomp.makeIterator(b), d = b.next();
    !d.done;
    d = b.next()
  ) {
    d = d.value;
...
$jscomp.string.startsWith = function (a, b) {
  ...
  for (
    var d = c.length,
      e = a.length,
      f = Math.max(0, Math.min(b | 0, c.length)),
      g = 0;
    g < e && f < d;
...
$jscomp.string.endsWith = function (a, b) {
  ...
  void 0 === b && (b = c.length);
  for (
    var d = Math.max(0, Math.min(b | 0, c.length)), e = a.length;
    0 < e && 0 < d;
...
var module$src$item = {},
  ...
  ItemList$$module$src$item,
  Empty$$module$src$item = { Record: {} },
  EmptyItemQuery$$module$src$item,
  emptyItemQuery$$module$src$item = Empty$$module$src$item.Record,
  ItemQuery$$module$src$item,
  ItemUpdate$$module$src$item;
...
Store$$module$src$store.prototype.remove = function (a, b) {
  var c,
    d = this.getLocalStorage().filter(function (b) {
  ...
  return a.reduce(function (a, c) {
    return (
      ...
      ('\n<li data-id="' +
        c.id +
        '"' +
        (c.completed ? ' class="completed"' : '') +
        '>\n\t<div class="view">\n\t\t<input class="toggle" type="checkbox" ' +
        (c.completed ? 'checked' : '') +
        '>\n\t\t<label>' +
        module$src$helpers.escapeForHTML(c.title) +
...
var module$src$view = {},
  _itemId$$module$src$view = function (a) {
    return parseInt(
      a.parentNode.dataset.id || a.parentNode.parentNode.dataset.id,
      10
    );
  },
...
View$$module$src$view.prototype.removeItem = function (a) {
  (a = module$src$helpers.qs('[data-id="' + a + '"]')) &&
    this.$todoList.removeChild(a);
};
View$$module$src$view.prototype.setItemsLeft = function (a) {
  this.$todoItemCounter.innerHTML = this.template.itemCounter(a);
};
View$$module$src$view.prototype.setClearCompletedButtonVisibility = function (
  a
) {
...
View$$module$src$view.prototype.setItemComplete = function (a, b) {
  ...
  c &&
    ((c.className = b ? 'completed' : ''),
    (module$src$helpers.qs('input', c).checked = b));
};
...
View$$module$src$view.prototype.bindEditItemCancel = function (a) {
  module$src$helpers.$delegate(
    ...
    function (b) {
      var c = b.target;
      b.keyCode === ESCAPE_KEY$$module$src$view &&
        ((c.dataset.iscanceled = !0), c.blur(), a(_itemId$$module$src$view(c)));
    }
  );
};
...
Controller$$module$src$controller.prototype.addItem = function (a) {
  var b = this;
  this.store.insert({ id: Date.now(), title: a, completed: !1 }, function () {
    b.view.clearNewTodo();
    b._filter(!0);
  });
};
Controller$$module$src$controller.prototype.editItemSave = function (a, b) {
  var c = this;
  b.length
    ? this.store.update({ id: a, title: b }, function () {
...
Controller$$module$src$controller.prototype._filter = function (a) {
  var b = this,
    c = this._activeRoute;
  (a || '' !== this._lastActiveRoute || this._lastActiveRoute !== c) &&
    this.store.find(
      {
...
var store$$module$src$app = new module$src$store['default'](
    'todos-vanilla-es6'
  ),
  template$$module$src$app = new module$src$template['default'](),
  view$$module$src$app = new module$src$view['default'](
    template$$module$src$app
  ),
  controller$$module$src$app = new module$src$controller['default'](
    store$$module$src$app,
    view$$module$src$app
  ),
